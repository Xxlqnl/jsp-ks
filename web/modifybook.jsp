...
<body>
    ...
    <div class="table">
        ...
        <table border="1" cellspacing="0">
            <form action="modifyBookServlet?id=${books.getId()}" method="post" enctype="multipart/form-data">
                <tr>
                    <td>书名</td>
                    <td class="value">
                        <input type="text" name="name" value="${books.getName()}">
                    </td>
                </tr>
                <tr>
                    <td>价格</td>
                    <td class="value">
                        <input type="text" name="price" value="${books.getPrice()}">
                    </td>
                </tr>
                <tr>
                    <td>分类</td>
                    <td class="value">
                        <select name="classly" id="sel">
                            <option value="儿童读物">儿童读物</option>
                            <option value="青年读物">青年读物</option>
                            <option value="科普百科">科普百科</option>
                            <option value="卡通动漫">卡通动漫</option>
                            <option value="著名宝藏">著名宝藏</option>
                        </select>
                    </td>
                </tr>
                <tr style="height: 100px;">
                    <td>详情</td>
                    <td class="value">
                        <textarea style="height: 80px;width: 300px;" name="detail" id="text"></textarea>
                    </td>
                </tr>
                <tr>
...
<script>
    document.getElementById("sel").value = "${books.getClassly()}";
    document.getElementById("text").value = "${books.getDetail()}";
</script>